...
$(document).ready(function(){var a=1;$("#load-more").on("click",function(){var e=$(this).parent().find("input#page").val(),n=Math.ceil(e/6),t=$("#append-load-more");$.ajax({url:"/loadmore",type:"GET",cache:!1,data:{now:a},success:function(e){e?((a+=1)==n&&$("#load-more").remove(),t.append(e)):alert("Vui lòng thử lại sau!")}})}),$("#load-more-cate").on("click",function(){var e=$(this).parent().find("input#page").val(),n=$(this).parent().find("input#slug").val(),t=Math.ceil(e/6),o=$("#append-load-more");$.ajax({url:"/loadmore-cate",type:"GET",cache:!1,data:{now:a,slug:n},success:function(e){e?((a+=1)==t&&$("#load-more-cate").remove(),o.append(e)):alert("Vui lòng thử lại sau!")}})}),$("#load-more-cata").on("click",function(){var e=$(this).parent().find("input#page").val(),n=$(this).parent().find("input#slug").val(),t=Math.ceil(e/6),o=$("#append-load-more");$.ajax({url:"/loadmore-cata",type:"GET",cache:!1,data:{now:a,slug:n},success:function(e){e?((a+=1)==t&&$("#load-more-cata").remove(),o.append(e)):alert("Vui lòng thử lại sau!")}})})});
